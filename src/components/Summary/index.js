        ...
        return (
            <summary className={style.summary}>
                <ul className={style.list}>
                    ...
                    <li className={style.reaction_border}>
                        ...
                        <span className={style.reaction}>Reaction</span>  
                        <div className={style.position_number}>
                            <b>80</b> <span className={style.number_color}> / 100 </span>   
                        </div>      
                    </li>
                    <li className={style.memory_border}>
                        ...
                        <span  className={style.memory}>  Memory </span>  
                        <div className={style.position_number}>
                           <b> 92</b> <span className={style.number_color}> / 100 </span>   
                        </div>              
                    </li>
                    <li className={style.verbal_border}>
                        ...
                        <span  className={style.verbal}> Verbal </span> 
                        <div className={style.position_number}>
                           <b>61</b><span className={style.number_color}> / 100 </span>   
                        </div>    
                    </li>
                    <li className={style.visual_border}>
                        ...
                        <span  className={style.visual}> Visual </span>
                        <div className={style.position_number}>
                           <b> 72</b> <span className={style.number_color}> / 100 </span>   
                        </div>    
                    </li>
                </ul>   
            </summary>
